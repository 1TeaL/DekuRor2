...
namespace DekuMod.SkillStates
{
    ...
    public class ShootStyleBulletStun : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            afterattack = new BulletAttack
            {
                ...
                tracerEffectPrefab = ShootStyleBulletStun.tracerEffectPrefab,
                spreadPitchScale = 0f,
                spreadYawScale = 0f,
        ...
        {
            this.rollSpeed = this.moveSpeedStat * ShootStyleBulletStun.SpeedCoefficient;
        }
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.cameraTargetParams) base.cameraTargetParams.fovOverride = Mathf.Lerp(ShootStyleBulletStun.dodgeFOV, 60f, base.fixedAge / ShootStyleBulletStun.duration);
            ...
            if (base.isAuthority && base.fixedAge >= ShootStyleBulletStun.duration)
            {
