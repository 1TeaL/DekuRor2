...
namespace DekuMod.SkillStates
{
	...
	public class ShootStyleKick2 : BaseSkillState

	{
		...
		public override void FixedUpdate()
		{
			...
			if (flag6)
			{
				base.cameraTargetParams.fovOverride = Mathf.Lerp(ShootStyleKick2.dodgeFOV, 60f, base.fixedAge / ShootStyleKick2.duration);
			}
			bool flag7 = base.isAuthority && this.stopwatch >= ShootStyleKick2.duration;
			if (flag7)
			{
		...
		protected virtual void OnHitEnemyAuthority()
		{
			...
			if (flag)
			{
				...
				base.PlayAnimation("FullBody, Override", "ShootStyleKickExit", "Attack.playbackRate", ShootStyleKick2.duration * 0.9f);
				this.stopwatch = ShootStyleKick2.duration - this.extraDuration;
				bool flag2 = base.cameraTargetParams;
				if (flag2)
				{
					base.cameraTargetParams.fovOverride = -1f;
				}
				EffectManager.SimpleMuzzleFlash(ShootStyleKick2.muzzleEffectPrefab, base.gameObject, "LFoot", false);
				EffectManager.SimpleMuzzleFlash(ShootStyleKick2.muzzleEffectPrefab2, base.gameObject, "LFoot", false);
				bool flag3 = base.characterMotor;
				if (flag3)
				{
					base.characterMotor.velocity = Vector3.zero;
					this.bounceVector = base.GetAimRay().direction * -1f;
					this.bounceVector.y = 1f;
					this.bounceVector *= ShootStyleKick2.bounceForce;
				}
