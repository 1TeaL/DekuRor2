...
//{
//    public class BlackWhipJump : MonoBehaviour
//    {
...
//            base.PlayAnimation("FullBody, Override", "HighJump", "HighJump.playbackRate", BlackWhipJump.jumpDuration);
...
//                base.characterMotor.rootMotion += this.flyVector * ((0.8f * this.moveSpeedStat) * Mage.FlyUpState.speedCoefficientCurve.Evaluate(base.fixedAge / BlackWhipJump.jumpDuration) * Time.fixedDeltaTime);
...
//            if (base.fixedAge >= (0.25f * BlackWhipJump.jumpDuration) && !this.slamIndicatorInstance)
//            {
//                this.CreateIndicator();
//            }

//            if (base.fixedAge >= BlackWhipJump.jumpDuration && !this.hasDropped)
//            {
//                this.StartDrop();
//            }
...
//            base.characterMotor.velocity.y = -BlackWhipJump.dropForce;
//        }
...
//                this.slamIndicatorInstance.localScale = Vector3.one * BlackWhipJump.slamRadius;
//            }
//        }
...
//            blastAttack.radius = BlackWhipJump.slamRadius;
//            blastAttack.procCoefficient = BlackWhipJump.slamProcCoefficient;
//            blastAttack.position = base.characterBody.footPosition;
//            blastAttack.attacker = base.gameObject;
//            blastAttack.crit = base.RollCrit();
//            blastAttack.baseDamage = base.characterBody.damage * BlackWhipJump.slamDamageCoefficient;
//            blastAttack.falloffModel = BlastAttack.FalloffModel.SweetSpot;
//            blastAttack.baseForce = BlackWhipJump.slamForce;
