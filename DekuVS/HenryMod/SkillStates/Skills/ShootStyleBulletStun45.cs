...
namespace DekuMod.SkillStates
{
    ...
    public class ShootStyleBulletStun45 : BaseSkillState
    {
        ...
        public static GameObject tracerEffectPrefab = Resources.Load<GameObject>("prefabs/effects/tracers/tracersmokeline/TracerMageIceLaser");
        ...
        public override void OnEnter()
        {
            ...
            afterattack = new BulletAttack
            {
                ...
                damage = Modules.StaticValues.shootbulletstun45DamageCoefficient * this.damageStat,
        ...
        {
            this.rollSpeed = this.moveSpeedStat * ShootStyleBulletStun45.SpeedCoefficient;
        }
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.cameraTargetParams) base.cameraTargetParams.fovOverride = Mathf.Lerp(ShootStyleBulletStun45.dodgeFOV, 60f, base.fixedAge / ShootStyleBulletStun45.duration);
            ...
            if (base.isAuthority && base.fixedAge >= ShootStyleBulletStun45.duration)
            {
