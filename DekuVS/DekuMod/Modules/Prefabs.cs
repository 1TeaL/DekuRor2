...
namespace DekuMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        internal static void RegisterNewSurvivor(GameObject bodyPrefab, GameObject displayPrefab, Color charColor, string namePrefix, UnlockableDef unlockableDef, float sortPosition)
        {
            ...
            string fullFailureString = DekuPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            DekuPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
