...
{
    internal class ServerForceGoBeyondStateNetworkRequest : INetMessage
    {
        NetworkInstanceId netID;

        public ServerForceGoBeyondStateNetworkRequest()
        {

        }

        public ServerForceGoBeyondStateNetworkRequest(NetworkInstanceId netID)
        {
            this.netID = netID;
        }
