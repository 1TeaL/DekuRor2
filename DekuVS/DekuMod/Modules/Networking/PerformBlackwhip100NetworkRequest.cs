...
{
    internal class PerformBlackwhip100NetworkRequest : INetMessage
    {
        //Network these ones.
        ...
        public PerformBlackwhip100NetworkRequest()
        {

        }

        public PerformBlackwhip100NetworkRequest(NetworkInstanceId netID, Vector3 origin, Vector3 direction, float damage)
        {
            this.netID = netID;
            this.origin = origin;
