...
{
    internal static class DekuAssets
    {
        ...
        internal static void PopulateAssets()
        {
            ...
            sphereIndicator = Modules.DekuAssets.mainAssetBundle.LoadAsset<GameObject>("spherePrefab");
        ...
        public static Material CreateMaterial(string materialName, float emission, Color emissionColor, float normalStrength)
        {
            ...
            Material tempMat = DekuAssets.mainAssetBundle.LoadAsset<Material>(materialName);
        ...
        {
            return DekuAssets.CreateMaterial(materialName, 0f);
        }

        public static Material CreateMaterial(string materialName, float emission)
        {
            return DekuAssets.CreateMaterial(materialName, emission, Color.white);
        }

        public static Material CreateMaterial(string materialName, float emission, Color emissionColor)
        {
            return DekuAssets.CreateMaterial(materialName, emission, emissionColor, 0f);
        }
        ...
        public static Material CreateHopooMaterial(string materialName)
        {
            ...
            tempMat = DekuAssets.mainAssetBundle.LoadAsset<Material>(materialName);
