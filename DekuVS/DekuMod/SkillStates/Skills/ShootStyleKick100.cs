...
namespace DekuMod.SkillStates
{
	...
	{
		public static SkillDef primaryDef = Deku.shootstylekick100SkillDef;
		...
		private GameObject explosionPrefab = RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/effects/SonicBoomEffect");
		...
		public override void OnEnter()
		{
			...
			this.attack.damage = base.characterBody.damage * Modules.StaticValues.shootkick100DamageCoefficient * this.moveSpeedStat / 7;
			...
			this.extraDuration = (Math.Max(ShootStyleKick100.hitExtraDuration / (num2 + 1f), ShootStyleKick100.minExtraDuration))/(attackSpeedStat/2);
			base.PlayAnimation("FullBody, Override", "ShootStyleKick", "Attack.playbackRate", ShootStyleKick100.duration * 1f);
		...
		private void RecalculateRollSpeed()
		{
			...
			this.rollSpeed = num * Mathf.Lerp(ShootStyleKick100.SpeedCoefficient, ShootStyleKick100.finalSpeedCoefficient, base.fixedAge / ShootStyleKick100.duration);
		}
		...
		public override void FixedUpdate()
		{
			...
			if (flag6)
			{
				base.cameraTargetParams.fovOverride = Mathf.Lerp(ShootStyleKick100.dodgeFOV, 60f, base.fixedAge / ShootStyleKick100.duration);
			}
			bool flag7 = base.isAuthority && this.stopwatch >= ShootStyleKick100.duration;
			if (flag7)
			{
		...
		protected virtual void OnHitEnemyAuthority()
		{
			...
			//base.skillLocator.primary.UnsetSkillOverride(base.skillLocator.primary, ShootStyleKick100.primaryDef, GenericSkill.SkillOverridePriority.Contextual);
			//base.skillLocator.primary.SetSkillOverride(base.skillLocator.primary, ShootStyleKick1002.primaryDef, GenericSkill.SkillOverridePriority.Contextual);
			...
			if (flag)
			{
				...
				base.PlayAnimation("FullBody, Override", "ShootStyleKickExit", "Attack.playbackRate", ShootStyleKick100.duration * 0.9f);
				...
				EffectManager.SimpleMuzzleFlash(ShootStyleKick100.muzzleEffectPrefab, base.gameObject, "LFoot", false);
				EffectManager.SimpleMuzzleFlash(ShootStyleKick100.muzzleEffectPrefab2, base.gameObject, "LFoot", false);
				...
				if (flag3)
				{
					...
					this.bounceVector *= ShootStyleKick100.bounceForce;
				}
