...
namespace DekuMod.SkillStates
{
	...
	public class OFAcycle2scepter : BaseSkillState
	{
		...
		public override void OnEnter()
		{
			...
			base.skillLocator.special.UnsetSkillOverride(base.skillLocator.special, OFAcycle1scepter.specialDef, GenericSkill.SkillOverridePriority.Contextual);
			base.skillLocator.special.SetSkillOverride(base.skillLocator.special, OFAcycle2scepter.specialDef, GenericSkill.SkillOverridePriority.Contextual);
