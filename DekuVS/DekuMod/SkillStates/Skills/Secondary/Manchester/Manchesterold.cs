...
{
    public class Manchesterold : BaseSkillState
    {
...
;
        ...
        public override void FixedUpdate()
        {
            ...
            if (!this.hasDropped)
            {
                base.characterMotor.rootMotion += this.flyVector * ((0.6f * this.moveSpeedStat * fajin) * EntityStates.Mage.FlyUpState.speedCoefficientCurve.Evaluate(base.fixedAge / jumpDuration) * Time.fixedDeltaTime);
        ...
        private void LandingImpact()
        {
            ...
            if (base.isAuthority)
            {
                ...
                BlastAttack blastAttack = new BlastAttack();
                blastAttack.radius = slamRadius * fajin;
