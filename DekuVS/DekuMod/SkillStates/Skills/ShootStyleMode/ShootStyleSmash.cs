...
namespace DekuMod.SkillStates.ShootStyle
{
    ...
    public class ShootStyleSmash : BaseDekuSkillState

    {
        ...
        public static float baseduration = StaticValues.shootstyleDashDuration;
        public static float duration;
        public static float hitExtraDuration = 0.44f;
        public static float minExtraDuration = 0.2f;
        public static float initialSpeedCoefficient = StaticValues.shootstyleSpeedCoefficient;
        ...
        public override void OnEnter()
        {
            ...
            switch (level)
            {
                case 0:
                    ...
                    break;
                case 1:
                    SpeedCoefficient *= StaticValues.shootstyle2Multiplier;
                    hitboxName = "ShootStyleHitboxBig";
                    hitboxName2 = "ShootStyleHitboxBig";
                    break;
                case 2:
                    SpeedCoefficient *= StaticValues.shootstyle3Multiplier;
                    hitboxName = "ShootStyleHitboxBig";
                    hitboxName2 = "ShootStyleHitboxBig";
                    break;
            }
            ...
            attack.damage = characterBody.damage * Modules.StaticValues.shootstyleDamageCoefficient * num3;
            ...
            animator.SetBool("attacking", true);
            GetModelAnimator().SetBool("shootstyleSmashDashEnd", false);
            if (characterMotor.isGrounded)
            {
                PlayCrossfade("FullBody, Override", "ShootStyleSmashDash", "Attack.playbackRate", duration, 0.1f);

            }
            else
            {
                PlayCrossfade("FullBody, Override", "ShootStyleSmashAir", "Attack.playbackRate", duration, 0.1f);
                        ...
                        if (flag2)
                        {
                            ...
                            switch (level)
                            {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    hurtBox.healthComponent.body.ApplyBuff(Modules.Buffs.comboDebuff.buffIndex, hurtBox.healthComponent.body.GetBuffCount(Modules.Buffs.comboDebuff) + 2);
                                    break;
                            }
                        }
                    }
        ...
        protected virtual void OnHitEnemyAuthority()
        {
            ...
            GetModelAnimator().SetBool("shootstyleSmashDashEnd", true);
