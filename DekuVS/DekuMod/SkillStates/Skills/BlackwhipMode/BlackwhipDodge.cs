...
{
    public class BlackwhipDodge : BaseSkillState
    {
        private bool startedStateGrounded;

        private Vector3 forwardDirection;
        private float baseslideDuration = StaticValues.blackwhipDodgeDuration;
        private float basejumpDuration = StaticValues.blackwhipDodgeDuration;
