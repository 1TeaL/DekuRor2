...
//          #pragma exclude_renderers d3d11
            ...
            { 
                ...
                transformedVertex.z = v.vertex.z + sin(v.vertex.y * _VertexFrequency + _Time * _VertexTimeMultiplier * _VertexFrequency) * _VertexWobble;
                transformedVertex.y = v.vertex.y + sin(v.vertex.y * _VertexFrequency + _Time * _VertexTimeMultiplier * _VertexFrequency) * _VertexWobble;
