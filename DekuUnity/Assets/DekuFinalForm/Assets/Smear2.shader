Shader "Custom/Smear2Shader"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _SmearAmount ("Smear Amount", Range(0, 100000)) = 0.5
        _SmearDirection ("Smear Direction", Vector) = (1, 0, 0)
	...
	SubShader
	{
		...
		void vert(inout appdata_full v, out Input o)
		{
            ...
            float3 worldOffset = normalize(_SmearDirection.xyz) * _SmearAmount;
	
			//fixed3 worldOffset = _Position.xyz - _PrevPosition.xyz; // -5
			fixed3 localOffset = worldPos.xyz - o.vertex.xyz; // -5
